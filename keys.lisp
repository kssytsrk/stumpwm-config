...
(fill-keymap *root-map*
             ...
             ;; cyrillic character kbds are for times when I'm on
             ;; ru or ua keyboard layout

             (kbd "C-t") "exec urxvt"
             (kbd "C-Cyrillic_ie") "exec urxvt"

             (kbd "C-e") "exec emacs"
             (kbd "C-Cyrillic_u") "exec emacs"

             (kbd "C-q") "exec qutebrowser"
             (kbd "C-Cyrillic_shorti") "exec qutebrowser"

             (kbd "C-m") "exec urxvt -e cmus"
             (kbd "C-Cyrillic_softsign") "exec urxvt -e cmus"

             (kbd "d") "dict"
             (kbd "Cyrillic_ve") "dict"
